...
func Test_finalPrices(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "test1", args: args{prices: []int{8, 4, 6, 2, 3}}, want: []int{4, 2, 4, 2, 3}},
		{name: "test2", args: args{prices: []int{1, 2, 3, 4, 5}}, want: []int{1, 2, 3, 4, 5}},
		{name: "test3", args: args{prices: []int{10, 1, 1, 6}}, want: []int{9, 0, 1, 6}},
	}
